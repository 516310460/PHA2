...
export default (context, inject) => {
    ...
    let zhCN = [{
        ...
        },
        {
            ...
            enMsg: "8-20 characters mixed with numbers and letters without spaces"
        }
    ];
    let zhTW = [{
            code: 500,
    ...
    let enUS = [{
        ...
        {
            code: 4014,
            cnMsg: "8-20 characters mixed with numbers and letters without spaces"
        }
    ];

    context.$errMsg = _temp;
    inject("errMsg", _temp);
}