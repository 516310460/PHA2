...
export default {
  ...
  //   let init_token = store.state.buybit_token.value;
  ...
  //     _token.access_token &&
  //     new Date().getTime() <
  //       new Date(_token[store.state.buybit_timestamp.type]).getTime()
  //   ) {
  //     /*客户端 重新写入access_token*/
  //     if (process.client) {
  //       const cookie_token = JSON.parse(
  //         jsCookie.get(store.state.buybit_token.type)
  //       );
  //       let isset = false;
  //       if (!cookie_token) {
  //         isset = true;
  //       } else if (!cookie_token.access_token || !cookie_token.buybit_TIMESTAMP) {
  //         isset = true;
  //       }
  //       if (isset) {
  ...
  //   info.uid = store.state.buybit_uid.value;
  //   info.key = store.state.buybit_key.value;
  //   if (!process.server) {
  //     info.ip = window.returnCitySN
  //       ? window.returnCitySN["cip"]
  //       : store.state.ip;
  //   }

  //   info.lang = store.state.buybit_lang.locale;
  //   return info;
  // },
  // getUserIP(onNewIP) {
  //   if (_ip) {
  ...
  //   const token = store.state.buybit_token.value;
