      ...
      <div class="new-money">
        ...
        <div class="new-money-list">
          <div class="new-money-list-content">
            <span class="new-money-title">{{ $t('HashRate.pro.header.title1') }}</span>
            <p
              class="new-money-num"
              v-if="countData.close"
            >
              <span class="new-money-dot">
                <span :class="countData.percent >= 0 ? 'rise' : 'fall'">{{ countData.close || '' }}</span>
          ...
          <div class="new-money-list-content">
            <span class="new-money-title">{{ $t('HashRate.pro.header.title2') }}</span>
            <p
              class="new-money-num"
          ...
          <div class="new-money-list-content">
            <span class="new-money-title">{{ $t('HashRate.pro.header.title3') }}</span>
            <p
              class="new-money-num"
              v-if="countData.high"
            >
          ...
          <div class="new-money-list-content">
            <span class="new-money-title">{{ $t('HashRate.pro.header.title4') }}</span>
            <p
              class="new-money-num"
              v-if="countData.low"
            >
          ...
          <div class="new-money-list-content">
            <span class="new-money-title">{{ $t('HashRate.pro.header.title5') }}</span>
            <p
              class="new-money-num"
              v-if="countData.vol"
            >
...
export default {
    ...
    this.$nextTick(() => {
      ...
      this.$bus.on("Login-Success", () => {
        if (this.$store.state.token) {
          this.ws.send(JSON.stringify({ "sub": "OrderChange", "coinTeam": "XBIT-USDT", "token": this.$store.state.token }))
        }
      });
    })
  },
  ...
  methods: {
    ...
    async initWebsocket () {
      ...
      this.ws.onopen = () => {
        this.ws.send(JSON.stringify({ "sub": "TopCount", "coinTeam": "XBIT-USDT" }))
