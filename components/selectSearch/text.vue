  ...
  <div class="select-search">
    <div class="vue-dropdown default-theme">
      <div
        ...
        @click="isShow = !isShow"
      >
        <i class="i-icon icon-weChat "></i>{{ itemlist.cur.label }}
      </div>
      <div class="list-and-search" :class="isShow ? 'on' : ''">
        <div class="search-module clearfix" v-show="isNeedSearch">
          ...
          />
          <i @click="clearValue()" class="el-icon-error"></i>
        </div>
        <ul class="list-module">
          ...
          >
            <span class="list-item-text"
              ><i class="i-icon icon-weChat"></i><span class="mleft">{{ item.label }}</span></span
            >
          </li>
        </ul>
